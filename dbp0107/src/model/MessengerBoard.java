...
public class MessengerBoard {
	...
	public MessengerBoard(int messenger_connect_board_no, int department_no, String customerId) {
		super();
		this.messenger_connect_board_no = messenger_connect_board_no;
		this.department_no = department_no;
	...
	public MessengerBoard(int messenger_connect_board_no, String title, String contents, Date createtime,
			int application_check, int department_no, String customer_name, String customerId) {
		super();
		this.messenger_connect_board_no = messenger_connect_board_no;
		this.title = title;
		this.contents = contents;
