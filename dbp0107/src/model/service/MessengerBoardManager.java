...
public class MessengerBoardManager {
   ...
   public MessengerBoard showDetail(int department_no, int messenger_connect_board_no, String customerId) throws SQLException {
	   MessengerBoard board = boardDAO.showDetail(department_no, messenger_connect_board_no, customerId);
